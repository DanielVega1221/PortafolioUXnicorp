...
import { BLOG_POSTS_EN, getPostEN } from "../data";
import { truncate } from "@/lib/truncate";
import { renderInlineLinks } from "@/components/blog/InlineLinks";
import Footer from "@/components/Footer";
import type { BlogSection } from "@/app/blog/data";
...
export async function generateMetadata({
  ...
  const canonicalUrl = `https://www.uxnicorp.com.ar/en/blog/${slug}`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        es: `https://www.uxnicorp.com.ar/blog/${slug}`,
        en: canonicalUrl,
        "x-default": `https://www.uxnicorp.com.ar/blog/${slug}`,
      },
    },
    openGraph: {
  ...
  const jsonLd = [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Blog", item: "https://www.uxnicorp.com.ar/en/blog" },
        ...
        <div className="mx-auto max-w-[860px] px-6 py-20 md:px-8 md:py-28">
          <nav aria-label="Breadcrumb" style={{ marginBottom: "2.5rem" }}>
            <ol style={{ display: "flex", alignItems: "center", gap: "0.5rem", listStyle: "none", padding: 0, margin: 0 }}>
              ...
              <li style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                <TransitionLink href="/en/blog" style={{ fontSize: "0.8rem", fontWeight: 600, color: "#974c67", textDecoration: "none" }}>
                  Blog
                </TransitionLink>
                <svg width="12" height="12" viewBox="0 0 12 12" fill="none" aria-hidden="true">
                  <path d="M4 2.5l4 3.5-4 3.5" stroke="#d1d5db" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" />
...
function BlogSection({ section, ctaHref, ctaLabel }: { section: BlogSection; ctaHref: string; ctaLabel: string }) {
  switch (section.type) {
    case "heading":
      return (
