...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Car Dealership Management Software | UXnicorp",
    description: "Custom car dealership management software: vehicle inventory, clients, financing and sales. Built from scratch in Argentina.",
    url: "https://www.uxnicorp.com.ar/en/servicios/management-systems/car-dealerships",
    type: "website",
    locale: "en_US",
    siteName: "UXnicorp",
    images: [{ url: "/og-image.jpg", width: 1343, height: 633, alt: "Car Dealership Management Software — UXnicorp" }],
  },
  twitter: {
...
export default function CarDealershipsPageEN() {
  const jsonLd = [
    {
      "@context": "https://schema.org",
      "@type": "Service",
      name: "Car Dealership Management Software",
      description: "Custom car dealership management software: vehicle inventory, clients, financing and sales.",
      url: "https://www.uxnicorp.com.ar/en/servicios/management-systems/car-dealerships",
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Car Dealerships", item: "https://www.uxnicorp.com.ar/en/servicios/management-systems/car-dealerships" },
      ],
    },
  ];
  ...
  return (
    ...
    <main style={{ background: "radial-gradient(ellipse 90% 48% at 72% 20%, rgba(224,166,216,0.70) 0%, rgba(202,222,249,0.72) 38%, rgba(254,224,214,0.66) 72%, rgba(255,255,255,0) 100%), #ffffff", minHeight: "100vh" }}>
      <Script id="car-dealerships-en-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} />
      <div className="mx-auto max-w-[1220px] px-6 py-20 md:px-8 md:py-28">
        <nav style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "2.5rem", flexWrap: "wrap" }}>
          ...
          <svg width="12" height="12" viewBox="0 0 12 12" fill="none"><path d="M4 2.5l4 3.5-4 3.5" stroke="#d1d5db" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" /></svg>
          <span style={{ fontSize: "0.8rem", color: "#6b7280" }}>Car Dealerships</span>
        </nav>
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2.5rem 2.75rem", background: "rgba(224,166,216,0.45)", border: "1px solid rgba(255,255,255,0.6)", boxShadow: "0 2px 20px rgba(0,0,0,0.05)", marginBottom: "2rem" }}>
          ...
          <h1 style={{ fontSize: "clamp(1.75rem, 4vw, 2.5rem)", fontWeight: 800, letterSpacing: "-0.04em", color: "#111", margin: "0 0 1rem 0", lineHeight: 1.1 }}>Car Dealership Management Software</h1>
          <p style={{ fontSize: "1rem", lineHeight: 1.7, color: "#374151", maxWidth: "640px", margin: 0 }}>
            Manage vehicle inventory, clients, financing and sales from a single platform. All custom-built for your dealership.
          </p>
        </div>
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2rem 2.25rem", background: "rgba(255,255,255,0.5)", border: "1px solid rgba(255,255,255,0.65)", boxShadow: "0 2px 16px rgba(0,0,0,0.04)", marginBottom: "2rem" }}>
          ...
          <p style={{ fontSize: "0.95rem", lineHeight: 1.7, color: "#374151", margin: 0 }}>
            Car dealerships lose control with spreadsheets, outdated inventory and untracked clients. They don&apos;t know what&apos;s available, what&apos;s sold, or when financing contracts expire.
          </p>
        </div>
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2rem 2.25rem", background: "rgba(255,255,255,0.5)", border: "1px solid rgba(255,255,255,0.65)", boxShadow: "0 2px 16px rgba(0,0,0,0.04)", marginBottom: "2rem" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            {[
              { titulo: "Vehicle inventory", texto: "Complete inventory with photos, price, status and features for each vehicle." },
              { titulo: "Client CRM", texto: "Buyer database, visit history, preferences and operations." },
              { titulo: "Financing", texto: "Financing plan management, installments, expirations and collections." },
              { titulo: "Sales and documents", texto: "Contract, invoice and sales document generation." },
              { titulo: "Reports", texto: "Dashboard with available vehicles, monthly sales, commissions and performance." },
            ].map((item) => (
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "1rem", marginBottom: "2rem" }}>
          {[
            { num: "01", titulo: "Analysis", texto: "We understand your dealership, your operations and what you need to manage." },
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2rem 2.25rem", background: "linear-gradient(135deg, #9040b0 0%, #E0A6D8 100%)", boxShadow: "0 8px 40px rgba(144,64,176,0.22)", display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: "1.5rem", marginBottom: "2.5rem" }}>
          <div>
            <h2 style={{ fontSize: "1.1rem", fontWeight: 800, color: "#fff", margin: "0 0 0.3rem 0", letterSpacing: "-0.03em" }}>Have a car dealership and want to organize it?</h2>
        ...
        <FaqBlock
          items={INDUSTRIA_FAQS_EN["car-dealerships"]}
          accent="#9040b0"
        ...
        <p className="mt-8 text-[0.75rem] text-gray-500">
          * Every car dealership is different. We always start with a free conversation to understand what your business needs before quoting.
        </p>
      </div>
    </main>
    <Footer locale="en" />
