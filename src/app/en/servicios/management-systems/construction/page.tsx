...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: {
      es: "https://www.uxnicorp.com.ar/servicios/sistemas-gestion/construccion",
      en: "https://www.uxnicorp.com.ar/en/servicios/management-systems/construction",
      "x-default": "https://www.uxnicorp.com.ar/servicios/sistemas-gestion/construccion",
    },
  },
  openGraph: {
    title: "Construction Management Software | UXnicorp",
    description: "Custom construction management software: project tracking, budgets, suppliers and documentation. Built from scratch in Argentina.",
    url: "https://www.uxnicorp.com.ar/en/servicios/management-systems/construction",
    type: "website",
    locale: "en_US",
    siteName: "UXnicorp",
    images: [{ url: "/og-image.jpg", width: 1343, height: 633, alt: "Construction Management Software — UXnicorp" }],
  },
  twitter: {
...
export default function ConstructionPageEN() {
  const jsonLd = [
    {
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Construction", item: "https://www.uxnicorp.com.ar/en/servicios/management-systems/construction" },
      ],
    },
  ];
  ...
  return (
    ...
    >
      <Script id="construction-en-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} />
      <div className="mx-auto max-w-[1220px] px-6 py-20 md:px-8 md:py-28">
        ...
        <nav style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "2.5rem", flexWrap: "wrap" }}>
          ...
          <svg width="12" height="12" viewBox="0 0 12 12" fill="none"><path d="M4 2.5l4 3.5-4 3.5" stroke="#d1d5db" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" /></svg>
          <span style={{ fontSize: "0.8rem", color: "#6b7280" }}>Construction</span>
        </nav>
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2.5rem 2.75rem", background: "rgba(224,166,216,0.45)", border: "1px solid rgba(255,255,255,0.6)", boxShadow: "0 2px 20px rgba(0,0,0,0.05)", marginBottom: "2rem" }}>
          ...
          <p style={{ fontSize: "1rem", lineHeight: 1.7, color: "#374151", maxWidth: "640px", margin: 0 }}>
            Manage your projects, suppliers, budgets and documentation from a single platform. All custom-built for your construction company, no generic software.
          </p>
        </div>
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2rem 2.25rem", background: "rgba(255,255,255,0.5)", border: "1px solid rgba(255,255,255,0.65)", boxShadow: "0 2px 16px rgba(0,0,0,0.04)", marginBottom: "2rem" }}>
          ...
          <p style={{ fontSize: "0.95rem", lineHeight: 1.7, color: "#374151", margin: 0 }}>
            Construction companies lose control with spreadsheets, outdated budgets and scattered documentation. They don&apos;t know the real status of each project, how much was actually spent, or where pending suppliers stand.
          </p>
        </div>
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2rem 2.25rem", background: "rgba(255,255,255,0.5)", border: "1px solid rgba(255,255,255,0.65)", boxShadow: "0 2px 16px rgba(0,0,0,0.04)", marginBottom: "2rem" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            {[
              { titulo: "Project tracking", texto: "Dashboard with project status, progress by stage, site photos and delay alerts." },
              { titulo: "Budget management", texto: "Detailed budgets per project, comparison with actual spending and variance control." },
              { titulo: "Suppliers and procurement", texto: "Supplier database, purchase orders, delivery tracking and payments." },
              { titulo: "Technical documentation", texto: "Plans, specifications and permits centralized and accessible from any device." },
              { titulo: "Executive reports", texto: "Executive summaries with financial progress, physical progress and project schedule." },
            ].map((item) => (
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "1rem", marginBottom: "2rem" }}>
          {[
            { num: "01", titulo: "Analysis", texto: "We understand your operation, your projects and what you need to control." },
            { num: "02", titulo: "Design", texto: "We design the interface so your team uses it without extensive training." },
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2rem 2.25rem", background: "linear-gradient(135deg, #9040b0 0%, #E0A6D8 100%)", boxShadow: "0 8px 40px rgba(144,64,176,0.22)", display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: "1.5rem", marginBottom: "2.5rem" }}>
          <div>
            <h2 style={{ fontSize: "1.1rem", fontWeight: 800, color: "#fff", margin: "0 0 0.3rem 0", letterSpacing: "-0.03em" }}>Have a construction company and want to organize it?</h2>
        ...
        <FaqBlock
          items={INDUSTRIA_FAQS_EN.construction}
          accent="#9040b0"
        ...
        <p className="mt-8 text-[0.75rem] text-gray-500">
          * Every construction company is different. We always start with a free conversation to understand what your business needs before quoting.
        </p>
