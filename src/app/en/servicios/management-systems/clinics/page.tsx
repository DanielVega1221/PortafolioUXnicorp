...
export const metadata: Metadata = {
  ...
  description:
    "Custom clinic management software: appointment scheduling, medical records, billing and patient management. Built from scratch in Argentina, no expensive licenses.",
  keywords: [
  ...
  openGraph: {
    title: "Clinic & Medical Practice Management System | UXnicorp",
    description: "Custom clinic management software: appointment scheduling, medical records, billing and patient management. Built from scratch in Argentina.",
    url: "https://www.uxnicorp.com.ar/en/servicios/management-systems/clinics",
    type: "website",
    locale: "en_US",
    siteName: "UXnicorp",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Clinic Management System — UXnicorp" }],
  },
  twitter: {
...
export default function ClinicsPageEN() {
  const jsonLd = [
    {
      ...
      "@type": "Service",
      name: "Clinic & Medical Practice Management System",
      description: "Custom clinic management software: appointment scheduling, medical records, billing and patient management. Built from scratch in Argentina.",
      url: "https://www.uxnicorp.com.ar/en/servicios/management-systems/clinics",
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Clinics", item: "https://www.uxnicorp.com.ar/en/servicios/management-systems/clinics" },
      ],
    },
  ];
  ...
  return (
    ...
    >
      <Script id="clinics-en-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} />
      <div className="mx-auto max-w-[1220px] px-6 py-20 md:px-8 md:py-28">
        ...
        <nav style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "2.5rem", flexWrap: "wrap" }}>
          ...
          <svg width="12" height="12" viewBox="0 0 12 12" fill="none"><path d="M4 2.5l4 3.5-4 3.5" stroke="#d1d5db" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" /></svg>
          <span style={{ fontSize: "0.8rem", color: "#6b7280" }}>Clinics</span>
        </nav>
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2.5rem 2.75rem", background: "rgba(224,166,216,0.45)", border: "1px solid rgba(255,255,255,0.6)", boxShadow: "0 2px 20px rgba(0,0,0,0.05)", marginBottom: "2rem" }}>
          ...
          <h1 style={{ fontSize: "clamp(1.75rem, 4vw, 2.5rem)", fontWeight: 800, letterSpacing: "-0.04em", color: "#111", margin: "0 0 1rem 0", lineHeight: 1.1 }}>
            Clinic & Medical Practice Management System
          </h1>
          <p style={{ fontSize: "1rem", lineHeight: 1.7, color: "#374151", maxWidth: "640px", margin: 0 }}>
            Appointment scheduling, medical records, billing and patient management from a single platform. All custom-built for your clinic, no expensive generic software.
          </p>
        </div>
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2rem 2.25rem", background: "rgba(255,255,255,0.5)", border: "1px solid rgba(255,255,255,0.65)", boxShadow: "0 2px 16px rgba(0,0,0,0.04)", marginBottom: "2rem" }}>
          ...
          <p style={{ fontSize: "0.95rem", lineHeight: 1.7, color: "#374151", margin: 0 }}>
            Clinics and practices lose time with paper agendas, spreadsheets and generic systems that don&apos;t adapt to their practice. Hard-to-search medical records, disconnected billing, and patients who don&apos;t receive reminders.
          </p>
        </div>
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2rem 2.25rem", background: "rgba(255,255,255,0.5)", border: "1px solid rgba(255,255,255,0.65)", boxShadow: "0 2px 16px rgba(0,0,0,0.04)", marginBottom: "2rem" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            {[
              { titulo: "Appointment scheduling", texto: "Online appointments with automatic confirmation, WhatsApp reminders and availability control per professional." },
              { titulo: "Digital medical records", texto: "Electronic medical records with quick search, prescriptions, studies and patient evolution." },
              { titulo: "Patient management", texto: "Patient database, appointment history, contact information and insurance details." },
              { titulo: "Integrated billing", texto: "Electronic billing connected to appointments. No double data entry." },
              { titulo: "Reports and metrics", texto: "Dashboard with daily appointments, most consulted professionals, revenue and occupancy." },
            ].map((item) => (
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "1rem", marginBottom: "2rem" }}>
          {[
            { num: "01", titulo: "Analysis", texto: "We understand your clinic, your operations and what you need to manage." },
            { num: "02", titulo: "Design", texto: "We design the interface to be usable by doctors and admin staff." },
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2rem 2.25rem", background: "linear-gradient(135deg, #9040b0 0%, #E0A6D8 100%)", boxShadow: "0 8px 40px rgba(144,64,176,0.22)", display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: "1.5rem", marginBottom: "2.5rem" }}>
          <div>
            <h3 style={{ fontSize: "1.1rem", fontWeight: 800, color: "#fff", margin: "0 0 0.3rem 0", letterSpacing: "-0.03em" }}>Have a clinic or practice and want to organize it?</h3>
        ...
        <p className="mt-8 text-[0.75rem] text-gray-400">
          * Every clinic is different. We always start with a free conversation to understand what your practice needs before quoting.
        </p>
