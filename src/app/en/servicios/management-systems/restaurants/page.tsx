...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Restaurant Management System | UXnicorp",
    description: "Custom restaurant management software: inventory control, reservations, billing and digital menu. Built from scratch in Argentina.",
    url: "https://www.uxnicorp.com.ar/en/servicios/management-systems/restaurants",
    type: "website",
    locale: "en_US",
    siteName: "UXnicorp",
    images: [{ url: "/og-image.jpg", width: 1343, height: 633, alt: "Restaurant Management System — UXnicorp" }],
  },
  twitter: {
...
export default function RestaurantsPageEN() {
  const jsonLd = [
    {
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Restaurants", item: "https://www.uxnicorp.com.ar/en/servicios/management-systems/restaurants" },
      ],
    },
  ];
  ...
  return (
    ...
    >
      <Script id="restaurants-en-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} />
      <div className="mx-auto max-w-[1220px] px-6 py-20 md:px-8 md:py-28">
        ...
        <nav style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "2.5rem", flexWrap: "wrap" }}>
          ...
          <svg width="12" height="12" viewBox="0 0 12 12" fill="none"><path d="M4 2.5l4 3.5-4 3.5" stroke="#d1d5db" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" /></svg>
          <span style={{ fontSize: "0.8rem", color: "#6b7280" }}>Restaurants</span>
        </nav>
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2.5rem 2.75rem", background: "rgba(224,166,216,0.45)", border: "1px solid rgba(255,255,255,0.6)", boxShadow: "0 2px 20px rgba(0,0,0,0.05)", marginBottom: "2rem" }}>
          ...
          <p style={{ fontSize: "1rem", lineHeight: 1.7, color: "#374151", maxWidth: "640px", margin: 0 }}>
            Manage your restaurant from a single platform: reservations, digital menu, inventory control, billing and reports. All custom-built for your business, no generic software.
          </p>
        </div>
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2rem 2.25rem", background: "rgba(255,255,255,0.5)", border: "1px solid rgba(255,255,255,0.65)", boxShadow: "0 2px 16px rgba(0,0,0,0.04)", marginBottom: "2rem" }}>
          ...
          <p style={{ fontSize: "0.95rem", lineHeight: 1.7, color: "#374151", margin: 0 }}>
            Restaurants lose time and money with spreadsheets, generic systems that don&apos;t adapt, or solutions that don&apos;t communicate with each other. Manual inventory, WhatsApp reservations without order, and billing disconnected from the rest of the business.
          </p>
        </div>
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2rem 2.25rem", background: "rgba(255,255,255,0.5)", border: "1px solid rgba(255,255,255,0.65)", boxShadow: "0 2px 16px rgba(0,0,0,0.04)", marginBottom: "2rem" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            {[
              { titulo: "Digital menu", texto: "Online menu updated in real time. Customers scan a QR code and see the full menu with prices, photos and options." },
              { titulo: "Reservation system", texto: "Online reservations with automatic confirmation, capacity control and reminders. No more WhatsApp dependency." },
              { titulo: "Inventory control", texto: "Ingredient and product tracking. Low stock alerts, automatic updates when billing." },
              { titulo: "Integrated billing", texto: "Electronic billing connected directly to sales. No double data entry." },
              { titulo: "Reports and metrics", texto: "Dashboard with daily sales, most ordered dishes, costs and profit margins." },
            ].map((item) => (
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "1rem", marginBottom: "2rem" }}>
          {[
            { num: "01", titulo: "Analysis", texto: "We understand your restaurant, your operations and what you need to control." },
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2rem 2.25rem", background: "linear-gradient(135deg, #9040b0 0%, #E0A6D8 100%)", boxShadow: "0 8px 40px rgba(144,64,176,0.22)", display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: "1.5rem", marginBottom: "2.5rem" }}>
          <div>
            <h2 style={{ fontSize: "1.1rem", fontWeight: 800, color: "#fff", margin: "0 0 0.3rem 0", letterSpacing: "-0.03em" }}>Have a restaurant and want to organize it?</h2>
            <p style={{ fontSize: "0.875rem", color: "rgba(255,255,255,0.85)", margin: 0 }}>Tell us about your restaurant and we&apos;ll build a custom proposal.</p>
          </div>
        ...
        <FaqBlock
          items={INDUSTRIA_FAQS_EN.restaurants}
          accent="#9040b0"
        ...
        <p className="mt-8 text-[0.75rem] text-gray-500">
          * Every restaurant is different. We always start with a free conversation to understand what your business needs before quoting.
        </p>
