...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Auto Repair Shop Management Software | UXnicorp",
    description: "Custom auto repair management software: work orders, parts, clients and quotes. Built from scratch in Argentina.",
    url: "https://www.uxnicorp.com.ar/en/servicios/management-systems/auto-repair",
    type: "website",
    locale: "en_US",
    siteName: "UXnicorp",
    images: [{ url: "/og-image.jpg", width: 1343, height: 633, alt: "Auto Repair Shop Management Software — UXnicorp" }],
  },
  twitter: {
...
export default function AutoRepairPageEN() {
  const jsonLd = [
    {
      "@context": "https://schema.org",
      "@type": "Service",
      name: "Auto Repair Shop Management Software",
      description: "Custom auto repair management software: work orders, parts, clients and quotes.",
      url: "https://www.uxnicorp.com.ar/en/servicios/management-systems/auto-repair",
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Auto Repair", item: "https://www.uxnicorp.com.ar/en/servicios/management-systems/auto-repair" },
      ],
    },
  ];
  ...
  return (
    ...
    <main style={{ background: "radial-gradient(ellipse 90% 48% at 72% 20%, rgba(224,166,216,0.70) 0%, rgba(202,222,249,0.72) 38%, rgba(254,224,214,0.66) 72%, rgba(255,255,255,0) 100%), #ffffff", minHeight: "100vh" }}>
      <Script id="auto-repair-en-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} />
      <div className="mx-auto max-w-[1220px] px-6 py-20 md:px-8 md:py-28">
        <nav style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "2.5rem", flexWrap: "wrap" }}>
          ...
          <svg width="12" height="12" viewBox="0 0 12 12" fill="none"><path d="M4 2.5l4 3.5-4 3.5" stroke="#d1d5db" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" /></svg>
          <span style={{ fontSize: "0.8rem", color: "#6b7280" }}>Auto Repair</span>
        </nav>
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2.5rem 2.75rem", background: "rgba(224,166,216,0.45)", border: "1px solid rgba(255,255,255,0.6)", boxShadow: "0 2px 20px rgba(0,0,0,0.05)", marginBottom: "2rem" }}>
          ...
          <h1 style={{ fontSize: "clamp(1.75rem, 4vw, 2.5rem)", fontWeight: 800, letterSpacing: "-0.04em", color: "#111", margin: "0 0 1rem 0", lineHeight: 1.1 }}>Auto Repair Shop Management Software</h1>
          <p style={{ fontSize: "1rem", lineHeight: 1.7, color: "#374151", maxWidth: "640px", margin: 0 }}>
            Manage work orders, parts, clients and quotes from a single platform. All custom-built for your auto repair shop.
          </p>
        </div>
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2rem 2.25rem", background: "rgba(255,255,255,0.5)", border: "1px solid rgba(255,255,255,0.65)", boxShadow: "0 2px 16px rgba(0,0,0,0.04)", marginBottom: "2rem" }}>
          ...
          <p style={{ fontSize: "0.95rem", lineHeight: 1.7, color: "#374151", margin: 0 }}>
            Auto repair shops lose control with paper work orders, untracked parts inventory, and clients who don&apos;t return due to lack of follow-up.
          </p>
        </div>
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2rem 2.25rem", background: "rgba(255,255,255,0.5)", border: "1px solid rgba(255,255,255,0.65)", boxShadow: "0 2px 16px rgba(0,0,0,0.04)", marginBottom: "2rem" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            {[
              { titulo: "Work orders", texto: "Digital work order management with status tracking, assigned technicians and deadlines." },
              { titulo: "Parts and inventory control", texto: "Real-time parts stock, suppliers, costs and automatic reorder alerts." },
              { titulo: "Quotes and estimates", texto: "Quote generation with detailed costs, labor and parts. Approval workflow." },
              { titulo: "Client and vehicle management", texto: "Client database linked to their vehicles, service history and contact data." },
              { titulo: "Productivity reports", texto: "Dashboard with revenue, active work orders, technician performance and shop efficiency." },
            ].map((item) => (
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "1rem", marginBottom: "2rem" }}>
          {[
            { num: "01", titulo: "Analysis", texto: "We understand your shop, your operations and what you need to manage." },
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2rem 2.25rem", background: "linear-gradient(135deg, #9040b0 0%, #E0A6D8 100%)", boxShadow: "0 8px 40px rgba(144,64,176,0.22)", display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: "1.5rem", marginBottom: "2.5rem" }}>
          <div>
            <h2 style={{ fontSize: "1.1rem", fontWeight: 800, color: "#fff", margin: "0 0 0.3rem 0", letterSpacing: "-0.03em" }}>Have an auto repair shop and want to organize it?</h2>
        ...
        <FaqBlock
          items={INDUSTRIA_FAQS_EN["auto-repair"]}
          accent="#9040b0"
        ...
        <p className="mt-8 text-[0.75rem] text-gray-500">
          * Every auto repair shop is different. We always start with a free conversation to understand what your business needs before quoting.
        </p>
      </div>
    </main>
    <Footer locale="en" />
