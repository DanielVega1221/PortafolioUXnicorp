...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://www.uxnicorp.com.ar/en/servicios/management-systems/hotels",
    type: "website",
    locale: "en_US",
    siteName: "UXnicorp",
  ...
  const jsonLd = [
    {
      ...
      description: "Custom hotel management software: reservations, guests, rooms and billing.",
      url: "https://www.uxnicorp.com.ar/en/servicios/management-systems/hotels",
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Hotels", item: "https://www.uxnicorp.com.ar/en/servicios/management-systems/hotels" },
      ],
    },
  ];
    ...
    <main style={{ background: "radial-gradient(ellipse 90% 48% at 72% 20%, rgba(224,166,216,0.70) 0%, rgba(202,222,249,0.72) 38%, rgba(254,224,214,0.66) 72%, rgba(255,255,255,0) 100%), #ffffff", minHeight: "100vh" }}>
      ...
      <div className="mx-auto max-w-[1220px] px-6 py-20 md:px-8 md:py-28">
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2.5rem 2.75rem", background: "rgba(224,166,216,0.45)", border: "1px solid rgba(255,255,255,0.6)", boxShadow: "0 2px 20px rgba(0,0,0,0.05)", marginBottom: "2rem" }}>
          ...
          <h1 style={{ fontSize: "clamp(1.75rem, 4vw, 2.5rem)", fontWeight: 800, letterSpacing: "-0.04em", color: "#111", margin: "0 0 1rem 0", lineHeight: 1.1 }}>Hotel Management Software</h1>
          <p style={{ fontSize: "1rem", lineHeight: 1.7, color: "#374151", maxWidth: "640px", margin: 0 }}>
            Manage reservations, guests, rooms and billing from a single platform. All custom-built for your hotel.
          </p>
        </div>
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2rem 2.25rem", background: "rgba(255,255,255,0.5)", border: "1px solid rgba(255,255,255,0.65)", boxShadow: "0 2px 16px rgba(0,0,0,0.04)", marginBottom: "2rem" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            {[
              { titulo: "Online reservations", texto: "Guests can book rooms directly from your website. Real-time availability and instant confirmation." },
              { titulo: "Digital check-in/check-out", texto: "Speed up arrivals and departures with digital registration. No more paper forms." },
              { titulo: "Room management", texto: "Full room inventory with status tracking, availability calendar and maintenance scheduling." },
              { titulo: "Billing and payments", texto: "Automated invoicing, payment tracking and integration with your payment processor." },
              { titulo: "Occupancy reports", texto: "Dashboard with occupancy rates, revenue per available room and booking trends." },
            ].map((item) => (
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "1rem", marginBottom: "2rem" }}>
          {[
            { num: "01", titulo: "Analysis", texto: "We understand your hotel, your operations and what you need to manage." },
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2rem 2.25rem", background: "linear-gradient(135deg, #9040b0 0%, #E0A6D8 100%)", boxShadow: "0 8px 40px rgba(144,64,176,0.22)", display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: "1.5rem", marginBottom: "2.5rem" }}>
          <div>
            <h3 style={{ fontSize: "1.1rem", fontWeight: 800, color: "#fff", margin: "0 0 0.3rem 0", letterSpacing: "-0.03em" }}>Have a hotel and want to organize it?</h3>
