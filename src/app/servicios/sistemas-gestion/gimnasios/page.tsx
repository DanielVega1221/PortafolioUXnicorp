...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: {
      es: "https://www.uxnicorp.com.ar/servicios/sistemas-gestion/gimnasios",
      en: "https://www.uxnicorp.com.ar/en/servicios/management-systems/gyms",
      "x-default": "https://www.uxnicorp.com.ar/servicios/sistemas-gestion/gimnasios",
    },
  },
  openGraph: {
    title: "Software para Gimnasios | UXnicorp",
    description: "Sistema de gestión para gimnasios: socios, pagos, turnos, clases y rutinas. Desarrollado a medida en Argentina.",
    url: "https://www.uxnicorp.com.ar/servicios/sistemas-gestion/gimnasios",
    type: "website",
    locale: "es_AR",
    siteName: "UXnicorp",
    images: [{ url: "/og-image.jpg", width: 1343, height: 633, alt: "Software para Gimnasios — UXnicorp" }],
  },
  twitter: {
...
export default function GimnasiosPage() {
  const jsonLd = [
    {
      ...
      description: "Sistema de gestión para gimnasios: socios, pagos, turnos, clases y rutinas.",
      url: "https://www.uxnicorp.com.ar/servicios/sistemas-gestion/gimnasios",
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Gimnasios", item: "https://www.uxnicorp.com.ar/servicios/sistemas-gestion/gimnasios" },
      ],
    },
  ];
  ...
  return (
    ...
    <main style={{ background: "radial-gradient(ellipse 90% 48% at 72% 20%, rgba(224,166,216,0.70) 0%, rgba(202,222,249,0.72) 38%, rgba(254,224,214,0.66) 72%, rgba(255,255,255,0) 100%), #ffffff", minHeight: "100vh" }}>
      <Script id="gimnasios-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} />
      <div className="mx-auto max-w-[1220px] px-6 py-20 md:px-8 md:py-28">
        <nav style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "2.5rem", flexWrap: "wrap" }}>
          ...
          <svg width="12" height="12" viewBox="0 0 12 12" fill="none"><path d="M4 2.5l4 3.5-4 3.5" stroke="#d1d5db" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" /></svg>
          <span style={{ fontSize: "0.8rem", color: "#6b7280" }}>Gimnasios</span>
        </nav>
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2.5rem 2.75rem", background: "rgba(224,166,216,0.45)", border: "1px solid rgba(255,255,255,0.6)", boxShadow: "0 2px 20px rgba(0,0,0,0.05)", marginBottom: "2rem" }}>
          ...
          <h1 style={{ fontSize: "clamp(1.75rem, 4vw, 2.5rem)", fontWeight: 800, letterSpacing: "-0.04em", color: "#111", margin: "0 0 1rem 0", lineHeight: 1.1 }}>Software para Gimnasios</h1>
          <p style={{ fontSize: "1rem", lineHeight: 1.7, color: "#374151", maxWidth: "640px", margin: 0 }}>
            Gestión de socios, pagos, turnos, clases y rutinas desde una única plataforma. Todo desarrollado a medida para tu gimnasio.
          </p>
        </div>
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2rem 2.25rem", background: "rgba(255,255,255,0.5)", border: "1px solid rgba(255,255,255,0.65)", boxShadow: "0 2px 16px rgba(0,0,0,0.04)", marginBottom: "2rem" }}>
          ...
          <p style={{ fontSize: "0.95rem", lineHeight: 1.7, color: "#374151", margin: 0 }}>
            Gimnasios pierden socios por falta de seguimiento, pagos atrasados no detectados, y agendas de clases desorganizadas.
          </p>
        </div>
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2rem 2.25rem", background: "rgba(255,255,255,0.5)", border: "1px solid rgba(255,255,255,0.65)", boxShadow: "0 2px 16px rgba(0,0,0,0.04)", marginBottom: "2rem" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            {[
              { titulo: "Gestión de socios", texto: "Altas, bajas, renovaciones y seguimiento de cada socio. Historial completo de actividad." },
              { titulo: "Control de pagos y cuotas", texto: "Registro de pagos, cuotas vencidas y alertas automáticas para recuperar socios morosos." },
              { titulo: "Agenda de clases", texto: "Organización de horarios, cupos, inscripciones y cancelaciones de clases grupales." },
              { titulo: "Rutinas y entrenadores", texto: "Asignación de entrenadores, seguimiento de rutinas personalizadas y progreso de cada socio." },
              { titulo: "Reportes de asistencia", texto: "Dashboard con estadísticas de asistencia, ingresos, socios activos y tendencias." },
            ].map((item) => (
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "1rem", marginBottom: "2rem" }}>
          {[
            { num: "01", titulo: "Análisis", texto: "Entendemos tu gimnasio, tu operación y qué necesitás gestionar." },
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2rem 2.25rem", background: "linear-gradient(135deg, #9040b0 0%, #E0A6D8 100%)", boxShadow: "0 8px 40px rgba(144,64,176,0.22)", display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: "1.5rem", marginBottom: "2.5rem" }}>
          <div>
            <h2 style={{ fontSize: "1.1rem", fontWeight: 800, color: "#fff", margin: "0 0 0.3rem 0", letterSpacing: "-0.03em" }}>¿Tenés un gimnasio y querés organizarlo?</h2>
        ...
        <FaqBlock items={INDUSTRIA_FAQS.gimnasios} accent="#9040b0" />

        <p className="mt-8 text-[0.75rem] text-gray-500">
          * Cada gimnasio es distinto. Siempre hacemos una primera charla gratuita para entender qué necesita tu negocio antes de presupuestar.
        </p>
      </div>
    </main>
    <Footer locale="es" />
