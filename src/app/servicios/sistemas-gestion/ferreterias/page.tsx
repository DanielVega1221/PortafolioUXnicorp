...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: {
      es: "https://www.uxnicorp.com.ar/servicios/sistemas-gestion/ferreterias",
      en: "https://www.uxnicorp.com.ar/en/servicios/management-systems/hardware-stores",
      "x-default": "https://www.uxnicorp.com.ar/servicios/sistemas-gestion/ferreterias",
    },
  },
  openGraph: {
    title: "Sistema para Ferreterías | UXnicorp",
    description: "Sistema de gestión para ferreterías: inventario, proveedores, ventas y clientes. Desarrollado a medida en Argentina.",
    url: "https://www.uxnicorp.com.ar/servicios/sistemas-gestion/ferreterias",
    type: "website",
    locale: "es_AR",
    siteName: "UXnicorp",
    images: [{ url: "/og-image.jpg", width: 1343, height: 633, alt: "Sistema para Ferreterías — UXnicorp" }],
  },
  twitter: {
...
export default function FerreteriasPage() {
  const jsonLd = [
    {
      ...
      "@type": "Service",
      name: "Sistema para Ferreterías",
      description: "Sistema de gestión para ferreterías: inventario, proveedores, ventas y clientes.",
      url: "https://www.uxnicorp.com.ar/servicios/sistemas-gestion/ferreterias",
      provider: { "@type": "Organization", name: "UXnicorp" },
      areaServed: { "@type": "Country", name: "Argentina" },
      category: "Hardware Store Management Software",
    },
    {
      "@context": "https://schema.org",
      "@type": "BreadcrumbList",
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Ferreterías", item: "https://www.uxnicorp.com.ar/servicios/sistemas-gestion/ferreterias" },
      ],
    },
  ];
  ...
  return (
    ...
    <main style={{ background: "radial-gradient(ellipse 90% 48% at 72% 20%, rgba(224,166,216,0.70) 0%, rgba(202,222,249,0.72) 38%, rgba(254,224,214,0.66) 72%, rgba(255,255,255,0) 100%), #ffffff", minHeight: "100vh" }}>
      <Script id="ferreterias-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} />
      <div className="mx-auto max-w-[1220px] px-6 py-20 md:px-8 md:py-28">
        <nav style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "2.5rem", flexWrap: "wrap" }}>
          ...
          <svg width="12" height="12" viewBox="0 0 12 12" fill="none"><path d="M4 2.5l4 3.5-4 3.5" stroke="#d1d5db" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" /></svg>
          <span style={{ fontSize: "0.8rem", color: "#6b7280" }}>Ferreterías</span>
        </nav>
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2.5rem 2.75rem", background: "rgba(224,166,216,0.45)", border: "1px solid rgba(255,255,255,0.6)", boxShadow: "0 2px 20px rgba(0,0,0,0.05)", marginBottom: "2rem" }}>
          ...
          <h1 style={{ fontSize: "clamp(1.75rem, 4vw, 2.5rem)", fontWeight: 800, letterSpacing: "-0.04em", color: "#111", margin: "0 0 1rem 0", lineHeight: 1.1 }}>Sistema para Ferreterías</h1>
          <p style={{ fontSize: "1rem", lineHeight: 1.7, color: "#374151", maxWidth: "640px", margin: 0 }}>
            Gestión de inventario, proveedores, ventas y clientes desde una única plataforma. Todo desarrollado a medida para tu ferretería.
          </p>
        </div>
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2rem 2.25rem", background: "rgba(255,255,255,0.5)", border: "1px solid rgba(255,255,255,0.65)", boxShadow: "0 2px 16px rgba(0,0,0,0.04)", marginBottom: "2rem" }}>
          ...
          <p style={{ fontSize: "0.95rem", lineHeight: 1.7, color: "#374151", margin: 0 }}>
            Las ferreterías pierden control con inventario en papel, proveedores sin seguimiento y ventas sin registrar. No saben qué falta, qué sobra ni cuánto venden por categoría.
          </p>
        </div>
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2rem 2.25rem", background: "rgba(255,255,255,0.5)", border: "1px solid rgba(255,255,255,0.65)", boxShadow: "0 2px 16px rgba(0,0,0,0.04)", marginBottom: "2rem" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            {[
              { titulo: "Control de inventario", texto: "Stock en tiempo real con alertas de reposición, códigos de barras y categorías de productos." },
              { titulo: "Gestión de proveedores", texto: "Base de datos de proveedores con historial de compras, precios y tiempos de entrega." },
              { titulo: "Ventas y facturación", texto: "Punto de venta con facturación electrónica, control de caja y medios de pago." },
              { titulo: "Clientes y crédito", texto: "Fichas de clientes con historial de compras, crédito y cuentas corrientes." },
              { titulo: "Reportes de rotación", texto: "Dashboard con productos más vendidos, rotación de stock, márgenes y tendencias." },
            ].map((item) => (
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "1rem", marginBottom: "2rem" }}>
          {[
            { num: "01", titulo: "Análisis", texto: "Entendemos tu ferretería, tu operación y qué necesitás gestionar." },
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2rem 2.25rem", background: "linear-gradient(135deg, #9040b0 0%, #E0A6D8 100%)", boxShadow: "0 8px 40px rgba(144,64,176,0.22)", display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: "1.5rem", marginBottom: "2.5rem" }}>
          <div>
            <h2 style={{ fontSize: "1.1rem", fontWeight: 800, color: "#fff", margin: "0 0 0.3rem 0", letterSpacing: "-0.03em" }}>¿Tenés una ferretería y querés organizarla?</h2>
        ...
        <FaqBlock items={INDUSTRIA_FAQS.ferreterias} accent="#9040b0" />

        <p className="mt-8 text-[0.75rem] text-gray-500">
          * Cada ferretería es distinta. Siempre hacemos una primera charla gratuita para entender qué necesita tu negocio antes de presupuestar.
        </p>
      </div>
    </main>
    <Footer locale="es" />
