...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://www.uxnicorp.com.ar/servicios/sistemas-gestion/construccion",
    type: "website",
    locale: "es_AR",
    siteName: "UXnicorp",
...
export default function ConstruccionPage() {
  const jsonLd = [
    {
      ...
      "@type": "Service",
      name: "Software para Constructoras y Obras",
      description: "Sistema de gestión para constructoras: control de obras, presupuestos, proveedores y documentación. Desarrollado a medida en Argentina.",
      url: "https://www.uxnicorp.com.ar/servicios/sistemas-gestion/construccion",
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Construcción", item: "https://www.uxnicorp.com.ar/servicios/sistemas-gestion/construccion" },
      ],
    },
  ];
  ...
  return (
    ...
    >
      <Script id="construccion-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} />
      <div className="mx-auto max-w-[1220px] px-6 py-20 md:px-8 md:py-28">
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2.5rem 2.75rem", background: "rgba(224,166,216,0.45)", border: "1px solid rgba(255,255,255,0.6)", boxShadow: "0 2px 20px rgba(0,0,0,0.05)", marginBottom: "2rem" }}>
          ...
          <h1 style={{ fontSize: "clamp(1.75rem, 4vw, 2.5rem)", fontWeight: 800, letterSpacing: "-0.04em", color: "#111", margin: "0 0 1rem 0", lineHeight: 1.1 }}>
            Software para Constructoras y Obras
          </h1>
          <p style={{ fontSize: "1rem", lineHeight: 1.7, color: "#374151", maxWidth: "640px", margin: 0 }}>
            Controlá tus obras, proveedores, presupuestos y documentación desde una única plataforma. Todo desarrollado a medida para tu constructora, sin depender de software genérico.
          </p>
        </div>
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2rem 2.25rem", background: "rgba(255,255,255,0.5)", border: "1px solid rgba(255,255,255,0.65)", boxShadow: "0 2px 16px rgba(0,0,0,0.04)", marginBottom: "2rem" }}>
          ...
          <p style={{ fontSize: "0.95rem", lineHeight: 1.7, color: "#374151", margin: 0 }}>
            Las constructoras pierden control con planillas de Excel, presupuestos desactualizados y documentación desperdigada. No saben el estado real de cada obra, cuánto se gastó realmente, o dónde están los proveedores pendientes.
          </p>
        </div>
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2rem 2.25rem", background: "rgba(255,255,255,0.5)", border: "1px solid rgba(255,255,255,0.65)", boxShadow: "0 2px 16px rgba(0,0,0,0.04)", marginBottom: "2rem" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            {[
              { titulo: "Control de obras", texto: "Dashboard con estado de cada obra, avance por etapa, fotos del sitio y alertas de retraso." },
              { titulo: "Gestión de presupuestos", texto: "Presupuestos detallados por obra, comparativa con gasto real y control de variaciones." },
              { titulo: "Proveedores y compras", texto: "Base de datos de proveedores, órdenes de compra, seguimiento de entregas y pagos." },
              { titulo: "Documentación técnica", texto: "Planos, especificaciones y permisos centralizados y accesibles desde cualquier dispositivo." },
              { titulo: "Reportes para dirección", texto: "Resúmenes ejecutivos con avance financiero, físico y cronograma de cada obra." },
            ].map((item) => (
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "1rem", marginBottom: "2rem" }}>
          {[
            { num: "01", titulo: "Análisis", texto: "Entendemos tu operación, tus obras y qué necesitás controlar." },
            { num: "02", titulo: "Diseño", texto: "Diseñamos la interfaz para que tu equipo la use sin capacitación extensa." },
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2rem 2.25rem", background: "linear-gradient(135deg, #9040b0 0%, #E0A6D8 100%)", boxShadow: "0 8px 40px rgba(144,64,176,0.22)", display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: "1.5rem", marginBottom: "2.5rem" }}>
          <div>
            <h3 style={{ fontSize: "1.1rem", fontWeight: 800, color: "#fff", margin: "0 0 0.3rem 0", letterSpacing: "-0.03em" }}>¿Tenés una constructora y querés organizarla?</h3>
