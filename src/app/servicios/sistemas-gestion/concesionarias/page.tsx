...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: {
      es: "https://www.uxnicorp.com.ar/servicios/sistemas-gestion/concesionarias",
      en: "https://www.uxnicorp.com.ar/en/servicios/management-systems/car-dealerships",
      "x-default": "https://www.uxnicorp.com.ar/servicios/sistemas-gestion/concesionarias",
    },
  },
  openGraph: {
    title: "Software para Concesionarias | UXnicorp",
    description: "Sistema de gestión para concesionarias: stock de vehículos, clientes, financiación y ventas. Desarrollado a medida en Argentina.",
    url: "https://www.uxnicorp.com.ar/servicios/sistemas-gestion/concesionarias",
    type: "website",
    locale: "es_AR",
    siteName: "UXnicorp",
    images: [{ url: "/og-image.jpg", width: 1343, height: 633, alt: "Software para Concesionarias — UXnicorp" }],
  },
  twitter: {
...
export default function ConcesionariasPage() {
  const jsonLd = [
    {
      ...
      "@type": "Service",
      name: "Software para Concesionarias",
      description: "Sistema de gestión para concesionarias: stock de vehículos, clientes, financiación y ventas.",
      url: "https://www.uxnicorp.com.ar/servicios/sistemas-gestion/concesionarias",
      provider: { "@type": "Organization", name: "UXnicorp" },
      areaServed: { "@type": "Country", name: "Argentina" },
      category: "Car Dealership Management Software",
    },
    {
      "@context": "https://schema.org",
      "@type": "BreadcrumbList",
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Concesionarias", item: "https://www.uxnicorp.com.ar/servicios/sistemas-gestion/concesionarias" },
      ],
    },
  ];
  ...
  return (
    ...
    <main style={{ background: "radial-gradient(ellipse 90% 48% at 72% 20%, rgba(224,166,216,0.70) 0%, rgba(202,222,249,0.72) 38%, rgba(254,224,214,0.66) 72%, rgba(255,255,255,0) 100%), #ffffff", minHeight: "100vh" }}>
      <Script id="concesionarias-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} />
      <div className="mx-auto max-w-[1220px] px-6 py-20 md:px-8 md:py-28">
        <nav style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "2.5rem", flexWrap: "wrap" }}>
          ...
          <svg width="12" height="12" viewBox="0 0 12 12" fill="none"><path d="M4 2.5l4 3.5-4 3.5" stroke="#d1d5db" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" /></svg>
          <span style={{ fontSize: "0.8rem", color: "#6b7280" }}>Concesionarias</span>
        </nav>
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2.5rem 2.75rem", background: "rgba(224,166,216,0.45)", border: "1px solid rgba(255,255,255,0.6)", boxShadow: "0 2px 20px rgba(0,0,0,0.05)", marginBottom: "2rem" }}>
          ...
          <h1 style={{ fontSize: "clamp(1.75rem, 4vw, 2.5rem)", fontWeight: 800, letterSpacing: "-0.04em", color: "#111", margin: "0 0 1rem 0", lineHeight: 1.1 }}>Software para Concesionarias</h1>
          <p style={{ fontSize: "1rem", lineHeight: 1.7, color: "#374151", maxWidth: "640px", margin: 0 }}>
            Gestión de stock de vehículos, clientes, financiación y ventas desde una única plataforma. Todo desarrollado a medida para tu concesionaria.
          </p>
        </div>
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2rem 2.25rem", background: "rgba(255,255,255,0.5)", border: "1px solid rgba(255,255,255,0.65)", boxShadow: "0 2px 16px rgba(0,0,0,0.04)", marginBottom: "2rem" }}>
          ...
          <p style={{ fontSize: "0.95rem", lineHeight: 1.7, color: "#374151", margin: 0 }}>
            Las concesionarias pierden control con planillas de Excel, vehículos sin actualizar y clientes sin seguimiento. No saben qué está disponible, qué se vendió ni cuándo vencen los contratos de financiación.
          </p>
        </div>
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2rem 2.25rem", background: "rgba(255,255,255,0.5)", border: "1px solid rgba(255,255,255,0.65)", boxShadow: "0 2px 16px rgba(0,0,0,0.04)", marginBottom: "2rem" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            {[
              { titulo: "Stock de vehículos", texto: "Inventario completo con fotos, precio, estado y características de cada vehículo." },
              { titulo: "CRM de clientes", texto: "Base de datos de compradores, historial de visitas, preferencias y operaciones." },
              { titulo: "Financiación", texto: "Gestión de planes de financiación, cuotas, vencimientos y cobros." },
              { titulo: "Ventas y documentos", texto: "Generación de contratos, facturas y documentación de venta." },
              { titulo: "Reportes", texto: "Dashboard con vehículos disponibles, ventas mensuales, comisiones y rendimiento." },
            ].map((item) => (
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "1rem", marginBottom: "2rem" }}>
          {[
            { num: "01", titulo: "Análisis", texto: "Entendemos tu concesionaria, tu operación y qué necesitás gestionar." },
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2rem 2.25rem", background: "linear-gradient(135deg, #9040b0 0%, #E0A6D8 100%)", boxShadow: "0 8px 40px rgba(144,64,176,0.22)", display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: "1.5rem", marginBottom: "2.5rem" }}>
          <div>
            <h2 style={{ fontSize: "1.1rem", fontWeight: 800, color: "#fff", margin: "0 0 0.3rem 0", letterSpacing: "-0.03em" }}>¿Tenés una concesionaria y querés organizarla?</h2>
        ...
        <FaqBlock items={INDUSTRIA_FAQS.concesionarias} accent="#9040b0" />

        <p className="mt-8 text-[0.75rem] text-gray-500">
          * Cada concesionaria es distinta. Siempre hacemos una primera charla gratuita para entender qué necesita tu negocio antes de presupuestar.
        </p>
      </div>
    </main>
    <Footer locale="es" />
