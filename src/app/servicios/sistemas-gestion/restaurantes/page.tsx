...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: {
      es: "https://www.uxnicorp.com.ar/servicios/sistemas-gestion/restaurantes",
      en: "https://www.uxnicorp.com.ar/en/servicios/management-systems/restaurants",
      "x-default": "https://www.uxnicorp.com.ar/servicios/sistemas-gestion/restaurantes",
    },
  },
  openGraph: {
    title: "Sistema de Gestión para Restaurantes | UXnicorp",
    description:
      "Software de gestión para restaurantes: control de stock, reservas, facturación y menú digital. Desarrollado a medida en Argentina.",
    url: "https://www.uxnicorp.com.ar/servicios/sistemas-gestion/restaurantes",
    type: "website",
    locale: "es_AR",
    siteName: "UXnicorp",
    images: [{ url: "/og-image.jpg", width: 1343, height: 633, alt: "Sistema de Gestión para Restaurantes — UXnicorp" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Sistema de Gestión para Restaurantes | UXnicorp",
    description: "Software de gestión para restaurantes: control de stock, reservas, facturación y menú digital. Desarrollado a medida en Argentina.",
    images: ["/og-image.jpg"],
  },
};
...
export default function RestaurantesPage() {
  const jsonLd = [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Restaurantes", item: "https://www.uxnicorp.com.ar/servicios/sistemas-gestion/restaurantes" },
      ],
    },
  ];
  ...
  return (
    ...
    >
      <Script id="restaurantes-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} />
      <div className="mx-auto max-w-[1220px] px-6 py-20 md:px-8 md:py-28">
        ...
        <nav style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "2.5rem", flexWrap: "wrap" }}>
          ...
          <svg width="12" height="12" viewBox="0 0 12 12" fill="none"><path d="M4 2.5l4 3.5-4 3.5" stroke="#d1d5db" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" /></svg>
          <span style={{ fontSize: "0.8rem", color: "#6b7280" }}>Restaurantes</span>
        </nav>
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2.5rem 2.75rem", background: "rgba(224,166,216,0.45)", border: "1px solid rgba(255,255,255,0.6)", boxShadow: "0 2px 20px rgba(0,0,0,0.05)", marginBottom: "2rem" }}>
          ...
          <p style={{ fontSize: "1rem", lineHeight: 1.7, color: "#374151", maxWidth: "640px", margin: 0 }}>
            Controlá tu restaurante desde una única plataforma: reservas, menú digital, control de stock, facturación y reportes. Todo desarrollado a medida para tu negocio, sin depender de software genérico.
          </p>
        </div>
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2rem 2.25rem", background: "rgba(255,255,255,0.5)", border: "1px solid rgba(255,255,255,0.65)", boxShadow: "0 2px 16px rgba(0,0,0,0.04)", marginBottom: "2rem" }}>
          ...
          <p style={{ fontSize: "0.95rem", lineHeight: 1.7, color: "#374151", margin: 0 }}>
            Los restaurantes pierden tiempo y dinero con hojas de cálculo, sistemas genéricos que no se adaptan, o soluciones que no se comunican entre sí. Control de stock manual, reservas por WhatsApp sin orden, y facturación desconectada del resto del negocio.
          </p>
        </div>
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2rem 2.25rem", background: "rgba(255,255,255,0.5)", border: "1px solid rgba(255,255,255,0.65)", boxShadow: "0 2px 16px rgba(0,0,0,0.04)", marginBottom: "2rem" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            {[
              { titulo: "Menú digital", texto: "Menú online actualizable en tiempo real. El cliente escanea un QR y ve el menú completo con precios, fotos y opciones." },
              { titulo: "Sistema de reservas", texto: "Reservas online con confirmación automática, control de capacidad y recordatorios. Sin depender de WhatsApp." },
              { titulo: "Control de stock", texto: "Seguimiento de ingredientes y productos. Alertas de stock bajo y actualización automática al facturar." },
              { titulo: "Facturación integrada", texto: "Facturación electrónica conectada directamente con las ventas. Sin cargar datos dos veces." },
              { titulo: "Reportes y métricas", texto: "Dashboard con ventas por día, platos más pedidos, costos y márgenes de ganancia." },
            ].map((item) => (
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "1rem", marginBottom: "2rem" }}>
          {[
            { num: "01", titulo: "Análisis", texto: "Entendemos tu restaurante, tu operación y qué necesitás controlar." },
        ...
        <div style={{ borderRadius: "1.5rem", padding: "2rem 2.25rem", background: "linear-gradient(135deg, #9040b0 0%, #E0A6D8 100%)", boxShadow: "0 8px 40px rgba(144,64,176,0.22)", display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: "1.5rem", marginBottom: "2.5rem" }}>
          <div>
            <h2 style={{ fontSize: "1.1rem", fontWeight: 800, color: "#fff", margin: "0 0 0.3rem 0", letterSpacing: "-0.03em" }}>¿Tenés un restaurante y querés organizarlo?</h2>
            <p style={{ fontSize: "0.875rem", color: "rgba(255,255,255,0.85)", margin: 0 }}>Contanos tu restaurante y te armamos una propuesta a medida.</p>
          </div>
        ...
        <FaqBlock items={INDUSTRIA_FAQS.restaurantes} accent="#9040b0" />

        <p className="mt-8 text-[0.75rem] text-gray-500">
          * Cada restaurante es distinto. Siempre hacemos una primera charla gratuita para entender qué necesita tu negocio antes de presupuestar.
        </p>
