...
export const seoConfig = {
  auditorias: {
    title: 'Auditorías UX/UI y CRO Argentina | Agencia Especializada - UXnicorp',
    description: 'Auditorías profesionales UX/UI, CRO y técnicas en Argentina. Mejoramos usabilidad, conversión y performance de tu web. Desde $120k. Entrega 5-15 días. Empresas en todo LATAM.',
    ...
    ogDescription: 'Análisis profesional de usabilidad y conversión desde $120.000. Mejoramos tu sitio con datos reales.',
  ...
  landingPages: {
    title: 'Landing Pages Argentina | Desarrollo Rápido desde $110k - UXnicorp',
    description: 'Landing pages profesionales en Argentina desde $110k. Express Basic, Intermedia, Full y Premium. Entregas en 3-72 horas. Diseño responsive, SEO optimizado. Desarrollado en React.',
  ...
  ecommerce: {
    title: 'E-commerce Argentina | Tienda Online desde $540k - UXnicorp',
    description: 'Desarrollo de tiendas online profesionales en Argentina desde $540k. E-commerce Simple, Robusto y Premium. Mercado Pago, envíos, panel admin. 3 meses de entrega. Clientes en todo LATAM.',
    ...
    ogTitle: 'E-commerce Argentina desde $540k - UXnicorp',
  ...
  sistemasGestion: {
    title: 'Sistemas ERP/CRM Argentina | Desarrollo a Medida desde $90k - UXnicorp',
    description: 'Desarrollo de sistemas ERP, CRM y software a medida en Argentina desde $90k. Automatización de procesos, gestión de clientes, inventario. 6-24 semanas. Escalable y personalizado.',
  ...
  paquetes: {
    title: 'Paquetes de Servicios Argentina | Soluciones Completas - UXnicorp',
    description: 'Paquetes integrales de desarrollo web en Argentina. Combina auditoría, diseño, desarrollo y soporte. Desde $180k. Soluciones a medida para tu negocio.',
