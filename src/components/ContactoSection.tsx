...
const equipo = [
  {
    ...
    tagline: "Escribime, te respondo el mismo día.",
    wa: GONZALO_WA,
  ...
  },
  {
    ...
    tagline: "Contame de tu proyecto.",
    wa: AILIN_WA,
...
export default function ContactoSection() {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    if (sendMode === "whatsapp") {
      ...
      window.open(
        `https://wa.me/${GONZALO_WA}?text=${encodeURIComponent(texto)}`,
        "_blank",
        "noopener,noreferrer"
      );
    } else {
      const subject = `Consulta de ${form.nombre} — ${form.tipo || "Proyecto"}`;
      ...
      <div className="mx-auto max-w-[1220px]">
        ...
        <div className="mb-14">
          ...
          <p className="mt-4 max-w-lg text-base leading-relaxed text-gray-500">
            Contanos qué necesita tu negocio. Te escuchamos, te preguntamos lo necesario y te respondemos con claridad.
          </p>
        </div>
