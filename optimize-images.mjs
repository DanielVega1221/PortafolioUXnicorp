 ...
 */
const DEFAULT_JPEG_QUALITY = Number(process.env.JPEG_QUALITY || 75);
const DEFAULT_WEBP_QUALITY = Number(process.env.WEBP_QUALITY || 70);
const DEFAULT_PNG_COMPRESSION = Number(process.env.PNG_COMPRESSION || 9); // 0–9
